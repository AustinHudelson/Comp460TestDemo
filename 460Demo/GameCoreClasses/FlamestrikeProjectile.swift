...
class FlamestrikeProjectile: Projectile {
    var caster: Unit
    var potentialTargets: Array<Unit> = []
    
    let searchArea: CGFloat = 80.0      /* Thickness of the fireball's search area */
    ...
    init(caster: Unit){
        ...
        let emitterPath: String = NSBundle.mainBundle().pathForResource("FlamestrikeParticle", ofType: "sks")!
